...
class OpticAlignmentCspadV2 (OpticAlignmentCspadMethods):
    ...
    def __init__(self, fname, path='calib-tmp', save_calib_files=True, print_bits=0o7777, plot_bits=0o377, exp='Any', det='CSPAD-XPP', n90=0):
    ...
    def readOpticalAlignmentFile(self):
        ...
        for linef in file:
            ...
            if line[0] == '#': # commented line
                if self.print_bits & 256: print('commented line')
                continue
...
def main():
    ...
    #base_dir = '/reg/g/psdm/detector/alignment/cspad/calib-.../'
    ...
    OpticAlignmentCspadV2(path_metrol, print_bits=opts.pbits, plot_bits=opts.gbits, n90=opts.n90)
    sys.exit()
