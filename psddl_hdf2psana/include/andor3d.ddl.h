#ifndef PSDDL_HDF2PSANA_ANDOR3D_DDL_H
#define PSDDL_HDF2PSANA_ANDOR3D_DDL_H 1
...
struct dataset_config {
  ...
  dataset_config();
  dataset_config(const Psana::Andor3d::ConfigV1& psanaobj);
  ~dataset_config();
...
class ConfigV1_v0 : public Psana::Andor3d::ConfigV1 {
public:
  typedef Psana::Andor3d::ConfigV1 PsanaType;
  ConfigV1_v0() {}
  ConfigV1_v0(hdf5pp::Group group, hsize_t idx)
    : m_group(group), m_idx(idx) {}
  ConfigV1_v0(const boost::shared_ptr<Andor3d::ns_ConfigV1_v0::dataset_config>& ds) : m_ds_config(ds) {}
  virtual ~ConfigV1_v0() {}
...
private:
  ...
  hsize_t m_idx;
  mutable boost::shared_ptr<Andor3d::ns_ConfigV1_v0::dataset_config> m_ds_config;
...
void store(const Psana::Andor3d::ConfigV1& obj, hdf5pp::Group group, int version = -1);
...
void store_at(const Psana::Andor3d::ConfigV1* obj, hdf5pp::Group group, long index = -1, int version = -1);
...
struct dataset_frame {
  ...
  dataset_frame();
  dataset_frame(const Psana::Andor3d::FrameV1& psanaobj);
  ~dataset_frame();
...
class FrameV1_v0 : public Psana::Andor3d::FrameV1 {
public:
...
private:
  ...
  mutable boost::shared_ptr<Andor3d::ns_FrameV1_v0::dataset_frame> m_ds_frame;
  void read_ds_frame() const;
  mutable ndarray<const float, 1> m_ds_temperature;
  void read_ds_temperature() const;
  mutable ndarray<const uint16_t, 3> m_ds_data;
...
/// Store object as a single instance (scalar dataset) inside specified group.
void store(const Psana::Andor3d::FrameV1& obj, hdf5pp::Group group, int version = -1);
/// Create container (rank=1) datasets for storing objects of specified type.
...
/// negative index means append to the end of dataset. If pointer to object is zero then
/// datsets are extended with zero-filled of default-initialized data.
void store_at(const Psana::Andor3d::FrameV1* obj, hdf5pp::Group group, long index = -1, int version = -1);

} // namespace Andor3d
} // namespace psddl_hdf2psana
#endif // PSDDL_HDF2PSANA_ANDOR3D_DDL_H
