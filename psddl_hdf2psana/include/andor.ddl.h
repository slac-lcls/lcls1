...
struct dataset_config {
  ...
  dataset_config();
  dataset_config(const Psana::Andor::ConfigV2& psanaobj);
  ~dataset_config();
...
class ConfigV2_v0 : public Psana::Andor::ConfigV2 {
public:
  typedef Psana::Andor::ConfigV2 PsanaType;
  ConfigV2_v0() {}
  ConfigV2_v0(hdf5pp::Group group, hsize_t idx)
    : m_group(group), m_idx(idx) {}
  ConfigV2_v0(const boost::shared_ptr<Andor::ns_ConfigV2_v0::dataset_config>& ds) : m_ds_config(ds) {}
  virtual ~ConfigV2_v0() {}
  virtual uint32_t width() const;
  virtual uint32_t height() const;
  virtual uint32_t orgX() const;
...
private:
  mutable hdf5pp::Group m_group;
  hsize_t m_idx;
  mutable boost::shared_ptr<Andor::ns_ConfigV2_v0::dataset_config> m_ds_config;
  void read_ds_config() const;
};
...
/// Store object as a single instance (scalar dataset) inside specified group.
void store(const Psana::Andor::ConfigV2& obj, hdf5pp::Group group, int version = -1);
/// Create container (rank=1) datasets for storing objects of specified type.
...
/// negative index means append to the end of dataset. If pointer to object is zero then
/// datsets are extended with zero-filled of default-initialized data.
void store_at(const Psana::Andor::ConfigV2* obj, hdf5pp::Group group, long index = -1, int version = -1);
