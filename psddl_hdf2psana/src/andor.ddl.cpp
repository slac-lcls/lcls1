...
hdf5pp::Type ns_ConfigV2_v0_dataset_config_stored_type()
{
  ...
  type.insert("exposureTime", offsetof(DsType, exposureTime), hdf5pp::TypeTraits<float>::stored_type());
  type.insert("coolingTemp", offsetof(DsType, coolingTemp), hdf5pp::TypeTraits<float>::stored_type());
  hdf5pp::EnumType<uint16_t> _enum_type_fanMode = hdf5pp::EnumType<uint16_t>::enumType();
  _enum_type_fanMode.insert("ENUM_FAN_FULL", Psana::Andor::ConfigV2::ENUM_FAN_FULL);
  _enum_type_fanMode.insert("ENUM_FAN_LOW", Psana::Andor::ConfigV2::ENUM_FAN_LOW);
  _enum_type_fanMode.insert("ENUM_FAN_OFF", Psana::Andor::ConfigV2::ENUM_FAN_OFF);
  _enum_type_fanMode.insert("ENUM_FAN_ACQOFF", Psana::Andor::ConfigV2::ENUM_FAN_ACQOFF);
  _enum_type_fanMode.insert("ENUM_FAN_NUM", Psana::Andor::ConfigV2::ENUM_FAN_NUM);
  type.insert("fanMode", offsetof(DsType, fanMode), _enum_type_fanMode);
  hdf5pp::EnumType<uint16_t> _enum_type_cropMode = hdf5pp::EnumType<uint16_t>::enumType();
  _enum_type_cropMode.insert("ENUM_CROP_OFF", Psana::Andor::ConfigV2::ENUM_CROP_OFF);
  _enum_type_cropMode.insert("ENUM_CROP_ON", Psana::Andor::ConfigV2::ENUM_CROP_ON);
  _enum_type_cropMode.insert("ENUM_CROP_EX", Psana::Andor::ConfigV2::ENUM_CROP_EX);
  _enum_type_cropMode.insert("ENUM_CROP_NUM", Psana::Andor::ConfigV2::ENUM_CROP_NUM);
  type.insert("cropMode", offsetof(DsType, cropMode), _enum_type_cropMode);
  type.insert("baselineClamp", offsetof(DsType, baselineClamp), hdf5pp::TypeTraits<uint8_t>::stored_type());
  type.insert("highCapacity", offsetof(DsType, highCapacity), hdf5pp::TypeTraits<uint8_t>::stored_type());
  type.insert("gainIndex", offsetof(DsType, gainIndex), hdf5pp::TypeTraits<uint8_t>::stored_type());
  type.insert("readoutSpeedIndex", offsetof(DsType, readoutSpeedIndex), hdf5pp::TypeTraits<uint16_t>::stored_type());
...
ns_ConfigV2_v0::dataset_config::dataset_config(const Psana::Andor::ConfigV2& psanaobj)
  : width(psanaobj.width())
  , height(psanaobj.height())
  , orgX(psanaobj.orgX())
  , orgY(psanaobj.orgY())
...
Psana::Andor::ConfigV2::EnumFanMode ConfigV2_v0::fanMode() const {
  if (not m_ds_config) read_ds_config();
  return Psana::Andor::ConfigV2::EnumFanMode(m_ds_config->fanMode);
}
Psana::Andor::ConfigV2::EnumCropMode ConfigV2_v0::cropMode() const {
  if (not m_ds_config) read_ds_config();
  return Psana::Andor::ConfigV2::EnumCropMode(m_ds_config->cropMode);
}
uint8_t ConfigV2_v0::baselineClamp() const {
  if (not m_ds_config) read_ds_config();
  return uint8_t(m_ds_config->baselineClamp);
}
uint8_t ConfigV2_v0::highCapacity() const {
  if (not m_ds_config) read_ds_config();
  return uint8_t(m_ds_config->highCapacity);
}
uint8_t ConfigV2_v0::gainIndex() const {
  if (not m_ds_config) read_ds_config();
  return uint8_t(m_ds_config->gainIndex);
}
...
uint16_t ConfigV2_v0::exposureEventCode() const {
  if (not m_ds_config) read_ds_config();
  return uint16_t(m_ds_config->exposureEventCode);
}
uint32_t ConfigV2_v0::numDelayShots() const {
  if (not m_ds_config) read_ds_config();
  return uint32_t(m_ds_config->numDelayShots);
}
uint32_t
...
void ConfigV2_v0::read_ds_config() const {
  m_ds_config = hdf5pp::Utils::readGroup<Andor::ns_ConfigV2_v0::dataset_config>(m_group, "config", m_idx);
}

void make_datasets_ConfigV2_v0(const Psana::Andor::ConfigV2& obj, 
      hdf5pp::Group group, const ChunkPolicy& chunkPolicy, int deflate, bool shuffle)
{
  {
    hdf5pp::Type dstype = Andor::ns_ConfigV2_v0::dataset_config::stored_type();
    hdf5pp::Utils::createDataset(group, "config", dstype, chunkPolicy.chunkSize(dstype), chunkPolicy.chunkCacheSize(dstype), deflate, shuffle);    
  }
}

void store_ConfigV2_v0(const Psana::Andor::ConfigV2* obj, hdf5pp::Group group, long index, bool append)
{
  if (obj) {
    Andor::ns_ConfigV2_v0::dataset_config ds_data(*obj);
    if (append) {
      hdf5pp::Utils::storeAt(group, "config", ds_data, index);
    } else {
      hdf5pp::Utils::storeScalar(group, "config", ds_data);
...
boost::shared_ptr<PSEvt::Proxy<Psana::Andor::ConfigV2> > make_ConfigV2(int version, hdf5pp::Group group, hsize_t idx) {
  switch (version) {
  case 0:
    return boost::make_shared<PSEvt::DataProxy<Psana::Andor::ConfigV2> >(boost::make_shared<ConfigV2_v0>(group, idx));
  default:
    return boost::make_shared<PSEvt::DataProxy<Psana::Andor::ConfigV2> >(boost::shared_ptr<Psana::Andor::ConfigV2>());
  }
}

void make_datasets(const Psana::Andor::ConfigV2& obj, hdf5pp::Group group, const ChunkPolicy& chunkPolicy,
                   int deflate, bool shuffle, int version)
{
  if (version < 0) version = 0;
  group.createAttr<uint32_t>("_schemaVersion").store(version);
  ...
  case 0:
    ...
    break;
  default:
    throw ExceptionSchemaVersion(ERR_LOC, "Andor.ConfigV2", version);
  }
}

void store_ConfigV2(const Psana::Andor::ConfigV2* obj, hdf5pp::Group group, long index, int version, bool append)
{
  if (version < 0) version = 0;
  if (not append) group.createAttr<uint32_t>("_schemaVersion").store(version);
  switch (version) {
...
void store(const Psana::Andor::ConfigV2& obj, hdf5pp::Group group, int version) 
{
  store_ConfigV2(&obj, group, 0, version, false);
}

void store_at(const Psana::Andor::ConfigV2* obj, hdf5pp::Group group, long index, int version)
{
...
template class FrameV1_v0<Psana::Andor::ConfigV2>;
...
boost::shared_ptr<PSEvt::Proxy<Psana::Andor::FrameV1> > make_FrameV1(int version, hdf5pp::Group group, hsize_t idx, const boost::shared_ptr<Psana::Andor::ConfigV2>& cfg) {
  switch (version) {
  case 0:
    return boost::make_shared<PSEvt::DataProxy<Psana::Andor::FrameV1> >(boost::make_shared<FrameV1_v0<Psana::Andor::ConfigV2> >(group, idx, cfg));
  default:
    return boost::make_shared<PSEvt::DataProxy<Psana::Andor::FrameV1> >(boost::shared_ptr<Psana::Andor::FrameV1>());
  }
}
