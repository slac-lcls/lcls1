...
hdf5pp::Type ns_ConfigV1_v0_dataset_config_stored_type()
{
  ...
  type.insert("numSensors", offsetof(DsType, numSensors), hdf5pp::TypeTraits<uint32_t>::stored_type());
  ...
  _enum_type_fanMode.insert("ENUM_FAN_FULL", Psana::Andor3d::ConfigV1::ENUM_FAN_FULL);
  _enum_type_fanMode.insert("ENUM_FAN_LOW", Psana::Andor3d::ConfigV1::ENUM_FAN_LOW);
  _enum_type_fanMode.insert("ENUM_FAN_OFF", Psana::Andor3d::ConfigV1::ENUM_FAN_OFF);
  _enum_type_fanMode.insert("ENUM_FAN_ACQOFF", Psana::Andor3d::ConfigV1::ENUM_FAN_ACQOFF);
  _enum_type_fanMode.insert("ENUM_FAN_NUM", Psana::Andor3d::ConfigV1::ENUM_FAN_NUM);
  ...
  type.insert("exposureStartDelay", offsetof(DsType, exposureStartDelay), hdf5pp::TypeTraits<uint32_t>::stored_type());
...
hdf5pp::Type ns_ConfigV1_v0_dataset_config_native_type()
{
  ...
  type.insert("numSensors", offsetof(DsType, numSensors), hdf5pp::TypeTraits<uint32_t>::native_type());
  ...
  type.insert("exposureStartDelay", offsetof(DsType, exposureStartDelay), hdf5pp::TypeTraits<uint32_t>::native_type());
...
ns_ConfigV1_v0::dataset_config::dataset_config(const Psana::Andor3d::ConfigV1& psanaobj)
  : width(psanaobj.width())
  , height(psanaobj.height())
  , numSensors(psanaobj.numSensors())
  , orgX(psanaobj.orgX())
  , orgY(psanaobj.orgY())
  , binX(psanaobj.binX())
  , binY(psanaobj.binY())
  ...
  , exposureStartDelay(psanaobj.exposureStartDelay())
...
uint32_t ConfigV1_v0::numSensors() const {
  if (not m_ds_config) read_ds_config();
  return uint32_t(m_ds_config->numSensors);
}
...
Psana::Andor3d::ConfigV1::EnumFanMode ConfigV1_v0::fanMode() const {
  if (not m_ds_config) read_ds_config();
  return Psana::Andor3d::ConfigV1::EnumFanMode(m_ds_config->fanMode);
}
...
uint32_t ConfigV1_v0::exposureStartDelay() const {
  if (not m_ds_config) read_ds_config();
  return uint32_t(m_ds_config->exposureStartDelay);
}
...
void ConfigV1_v0::read_ds_config() const {
  m_ds_config = hdf5pp::Utils::readGroup<Andor3d::ns_ConfigV1_v0::dataset_config>(m_group, "config", m_idx);
}

void make_datasets_ConfigV1_v0(const Psana::Andor3d::ConfigV1& obj, 
      hdf5pp::Group group, const ChunkPolicy& chunkPolicy, int deflate, bool shuffle)
{
  {
    hdf5pp::Type dstype = Andor3d::ns_ConfigV1_v0::dataset_config::stored_type();
...
void store_ConfigV1_v0(const Psana::Andor3d::ConfigV1* obj, hdf5pp::Group group, long index, bool append)
{
  if (obj) {
    Andor3d::ns_ConfigV1_v0::dataset_config ds_data(*obj);
    if (append) {
...
boost::shared_ptr<PSEvt::Proxy<Psana::Andor3d::ConfigV1> > make_ConfigV1(int version, hdf5pp::Group group, hsize_t idx) {
  switch (version) {
  case 0:
    return boost::make_shared<PSEvt::DataProxy<Psana::Andor3d::ConfigV1> >(boost::make_shared<ConfigV1_v0>(group, idx));
  default:
    return boost::make_shared<PSEvt::DataProxy<Psana::Andor3d::ConfigV1> >(boost::shared_ptr<Psana::Andor3d::ConfigV1>());
  }
}

void make_datasets(const Psana::Andor3d::ConfigV1& obj, hdf5pp::Group group, const ChunkPolicy& chunkPolicy,
                   int deflate, bool shuffle, int version)
{
  ...
  case 0:
    ...
    break;
  default:
    throw ExceptionSchemaVersion(ERR_LOC, "Andor3d.ConfigV1", version);
  }
}

void store_ConfigV1(const Psana::Andor3d::ConfigV1* obj, hdf5pp::Group group, long index, int version, bool append)
{
  if (version < 0) version = 0;
...
void store(const Psana::Andor3d::ConfigV1& obj, hdf5pp::Group group, int version) 
{
  store_ConfigV1(&obj, group, 0, version, false);
}

void store_at(const Psana::Andor3d::ConfigV1* obj, hdf5pp::Group group, long index, int version)
{
...
ns_FrameV1_v0::dataset_frame::dataset_frame(const Psana::Andor3d::FrameV1& psanaobj)
...
template <typename Config>
ndarray<const float, 1> FrameV1_v0<Config>::temperature() const {
  if (m_ds_temperature.empty()) read_ds_temperature();
  return m_ds_temperature;
}
template <typename Config>
ndarray<const uint16_t, 3> FrameV1_v0<Config>::data() const {
  if (m_ds_data.empty()) read_ds_data();
  return m_ds_data;
}
template <typename Config>
void FrameV1_v0<Config>::read_ds_frame() const {
  m_ds_frame = hdf5pp::Utils::readGroup<Andor3d::ns_FrameV1_v0::dataset_frame>(m_group, "frame", m_idx);
}
template <typename Config>
void FrameV1_v0<Config>::read_ds_temperature() const {
  if (not m_group.hasChild("temperature")) {
    m_ds_temperature = ndarray<float, 1>();
    return;
  }
  m_ds_temperature = hdf5pp::Utils::readNdarray<float, 1>(m_group, "temperature", m_idx);
}
template <typename Config>
void FrameV1_v0<Config>::read_ds_data() const {
  if (not m_group.hasChild("data")) {
    m_ds_data = ndarray<uint16_t, 3>();
    return;
  }
  m_ds_data = hdf5pp::Utils::readNdarray<uint16_t, 3>(m_group, "data", m_idx);
}
template class FrameV1_v0<Psana::Andor3d::ConfigV1>;

void make_datasets_FrameV1_v0(const Psana::Andor3d::FrameV1& obj, 
      hdf5pp::Group group, const ChunkPolicy& chunkPolicy, int deflate, bool shuffle)
{
  {
    hdf5pp::Type dstype = Andor3d::ns_FrameV1_v0::dataset_frame::stored_type();
  ...
  {
    typedef __typeof__(obj.temperature()) PsanaArray;
    const PsanaArray& psana_array = obj.temperature();
    if (psana_array.size() > 0) {
    hdf5pp::Type dstype = hdf5pp::ArrayType::arrayType(hdf5pp::TypeTraits<float>::stored_type(), psana_array.shape()[0]);
    hdf5pp::Utils::createDataset(group, "temperature", dstype, chunkPolicy.chunkSize(dstype), chunkPolicy.chunkCacheSize(dstype), deflate, shuffle);    
    }
  }
  {
...
void store_FrameV1_v0(const Psana::Andor3d::FrameV1* obj, hdf5pp::Group group, long index, bool append)
{
  if (obj) {
    Andor3d::ns_FrameV1_v0::dataset_frame ds_data(*obj);
    if (append) {
  ...
  if (group.hasChild("temperature")) {
  if (append) {
    if (obj) {
      hdf5pp::Utils::storeNDArrayAt(group, "temperature", obj->temperature(), index);
    } else {
      hdf5pp::Utils::resizeDataset(group, "temperature", index < 0 ? index : index + 1);
    }
  } else {
    hdf5pp::Utils::storeNDArray(group, "temperature", obj->temperature());
  }
  }
  if (group.hasChild("data")) {
  if (append) {
    if (obj) {
...
boost::shared_ptr<PSEvt::Proxy<Psana::Andor3d::FrameV1> > make_FrameV1(int version, hdf5pp::Group group, hsize_t idx, const boost::shared_ptr<Psana::Andor3d::ConfigV1>& cfg) {
  switch (version) {
  case 0:
    return boost::make_shared<PSEvt::DataProxy<Psana::Andor3d::FrameV1> >(boost::make_shared<FrameV1_v0<Psana::Andor3d::ConfigV1> >(group, idx, cfg));
  default:
    return boost::make_shared<PSEvt::DataProxy<Psana::Andor3d::FrameV1> >(boost::shared_ptr<Psana::Andor3d::FrameV1>());
  }
}

void make_datasets(const Psana::Andor3d::FrameV1& obj, hdf5pp::Group group, const ChunkPolicy& chunkPolicy,
                   int deflate, bool shuffle, int version)
{
  if (version < 0) version = 0;
  group.createAttr<uint32_t>("_schemaVersion").store(version);
  ...
  case 0:
    ...
    break;
  default:
    throw ExceptionSchemaVersion(ERR_LOC, "Andor3d.FrameV1", version);
  }
}

void store_FrameV1(const Psana::Andor3d::FrameV1* obj, hdf5pp::Group group, long index, int version, bool append)
{
  if (version < 0) version = 0;
  if (not append) group.createAttr<uint32_t>("_schemaVersion").store(version);
  switch (version) {
...
void store(const Psana::Andor3d::FrameV1& obj, hdf5pp::Group group, int version) 
{
  store_FrameV1(&obj, group, 0, version, false);
}

void store_at(const Psana::Andor3d::FrameV1* obj, hdf5pp::Group group, long index, int version)
{
