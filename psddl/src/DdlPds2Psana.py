...
class DdlPds2Psana ( object ) :
    ...
    def parseTree ( self, model ) :
        ...
        print("#include <boost/shared_ptr.hpp>", file=self.inc)
        ...
        print(T("#include \"$inc\"")(locals()), file=self.inc)
        ...
        for use in model.use:
            ...
            for header in headers:
                print(T("#include \"$header\"")(locals()), file=self.inc)
    ...
    def _genEnum(self, enum):
        ...
        print(_TEMPL('enum_pds_to_psana').render(locals()), file=self.cpp)
    ...
    def _genValueType(self, type):
        ...
        print(T("$psana_ns::$typename pds_to_psana($pdsdata_ns::$typename pds);\n")\
            (self.__dict__, typename=typename), file=self.inc)

        print(T("$psana_ns::$typename pds_to_psana($pdsdata_ns::$typename pds)\n{")\
            (self.__dict__, typename=typename), file=self.cpp)
        print(T("  return $psana_ns::$typename($ctor_args);")\
            (locals(), psana_ns=self.psana_ns), file=self.cpp)
        print("}\n", file=self.cpp)
    ...
    def _genAbsType(self, type):
        ...
        print(_TEMPL('abs_type_decl').render(locals()), file=self.inc)
