...
public:
  ...
  virtual uint32_t npvLabels() const = 0;
  /** PVControl configuration objects */
  virtual ndarray<const ControlData::PVControlV1, 1> pvControls() const = 0;
  /** PVMonitor configuration objects */
  virtual ndarray<const ControlData::PVMonitorV1, 1> pvMonitors() const = 0;
  /** PVLabel configuration objects */
  virtual ndarray<const ControlData::PVLabelV1, 1> pvLabels() const = 0;
};
} // namespace ControlData
} // namespace Psana
