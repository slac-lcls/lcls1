#ifndef PSANA_ANDOR3D_DDL_H
#define PSANA_ANDOR3D_DDL_H 1
...
public:
  ...
  virtual uint32_t numSensors() const = 0;
  ...
  virtual Andor3d::ConfigV1::EnumFanMode fanMode() const = 0;
  ...
  virtual uint32_t exposureStartDelay() const = 0;
  ...
  virtual uint32_t numPixelsPerSensor() const = 0;
...
public:
  ...
  virtual ndarray<const float, 1> temperature() const = 0;
  virtual ndarray<const uint16_t, 3> data() const = 0;
};
} // namespace Andor3d
} // namespace Psana
#endif // PSANA_ANDOR3D_DDL_H
