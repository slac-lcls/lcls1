  ...
  [[pack(4)]]
{
  ...
  char _name[NameSize] -> name  [[shape_method(None)]];	/* Name of the control. */
  ...
  [[pack(4)]]
{
  ...
  char _name[NameSize] -> name  [[shape_method(None)]];	/* PV name. */
  char _value[ValueSize] -> value  [[shape_method(None)]];	/* Label value. */
  ...
  [[config_type]]
{
  ...
  uint32_t _npvMonitors -> npvMonitors; /* Number of PVMonitor objects in this configuration. */
  uint32_t _npvLabels -> npvLabels; /* Number of PVLabel objects in this configuration. */
  PVControlV1 _pvControls[@self.npvControls()] -> pvControls  [[shape_method(pvControls_shape)]]; /* PVControl configuration objects */
  PVMonitorV1 _pvMonitors[@self.npvMonitors()] -> pvMonitors  [[shape_method(pvMonitors_shape)]]; /* PVMonitor configuration objects */
  PVLabelV1 _pvLabels[@self.npvLabels()] -> pvLabels  [[shape_method(pvLabels_shape)]];   /* PVLabel configuration objects */
