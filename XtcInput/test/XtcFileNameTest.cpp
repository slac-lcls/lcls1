...
BOOST_AUTO_TEST_CASE( test_1 )
{
  ...
  BOOST_CHECK_EQUAL ( name.expPrefix(), "e1" ) ;
...
BOOST_AUTO_TEST_CASE( test_2 )
{
  ...
  BOOST_CHECK_EQUAL ( name.small(), false ) ;
  BOOST_CHECK_EQUAL ( name.expPrefix(), "e123456" ) ;
...
{
  XtcFileName name;
  BOOST_CHECK_NO_THROW( name = XtcFileName("/dir", "e1", 2, 3, 4, false) ) ;
  ...
  BOOST_CHECK_NO_THROW( name = XtcFileName("/dir", "e1", 2, 3, 4, true) ) ;
...
BOOST_AUTO_TEST_CASE( test_4 )
{
  ...
  BOOST_CHECK_EQUAL ( name.small(), false ) ;
  BOOST_CHECK_EQUAL ( name.path(), "/dir/e1-r0002-s03-c04.xtc" ) ;
  BOOST_CHECK_NO_THROW( name = XtcFileName("", "e1", 2, 3, 4, false) ) ;
  ...
  BOOST_CHECK_EQUAL ( name.small(), true ) ;
  BOOST_CHECK_EQUAL ( name.path(), "/dir/e1-r0002-s03-c04.smd.xtc" ) ;
  BOOST_CHECK_NO_THROW( name = XtcFileName("", "e1", 2, 3, 4, true) ) ;
...
{
  XtcFileName name;
  BOOST_CHECK_NO_THROW( name = XtcFileName("/dir", "e123456", 234567, 345678, 456789, true) ) ;
  BOOST_CHECK_EQUAL ( name.small(), true ) ;
  ...
  BOOST_CHECK_NO_THROW( name = XtcFileName("/dir", "e123456", 234567, 345678, 456789, false) ) ;
  BOOST_CHECK_EQUAL ( name.small(), false ) ;
...
BOOST_AUTO_TEST_CASE( test_fail_1 )
{
  ...
  BOOST_CHECK_EQUAL ( name.small(), false ) ;
  BOOST_CHECK_EQUAL ( name.expPrefix(), "" ) ;
  ...
  BOOST_CHECK_EQUAL ( name.small(), false ) ;
  BOOST_CHECK_EQUAL ( name.expPrefix(), "e-1" ) ;
  BOOST_CHECK_EQUAL ( name.run(), 2U ) ;
  BOOST_CHECK_EQUAL ( name.stream(), 3U ) ;
  BOOST_CHECK_EQUAL ( name.chunk(), 4U ) ;
