...
/*
 * class SmlDataFileHeaderV1
 */ 
SmlDataFileHeaderV1::SmlDataFileHeaderV1(const SmlDataList& list) :
  typeId(TypeId::Id_SmlData, iXtcSmlDataVersion)
{
...
SmlDataFileHeaderV1::SmlDataFileHeaderV1(const SmlDataFileHeaderV1& headerV1) :
  typeId(TypeId::Id_SmlData, iXtcSmlDataVersion),
...
/*
 * class SmlDataFileL1NodeV1
 */ 
SmlDataFileL1NodeV1::SmlDataFileL1NodeV1(const L1AcceptNode& node) :
