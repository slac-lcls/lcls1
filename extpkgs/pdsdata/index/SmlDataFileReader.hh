#ifndef Pds_SmlData_SmlDataFileReader_hh
#define Pds_SmlData_SmlDataFileReader_hh
...
private:
  ...
  int                    _fdXtcIndex;
  SmlDataFileHeaderType  _fileHeader;
  int                    _iSizeHeader; 
  std::vector<CalibNode> _lCalib;
  std::vector<uint8_t>   _lEvrEvent;
  std::vector<ProcInfo>  _lDetector;
  TListOfTypeList        _lTypeList;
  TListOfSrcList         _lSrcList;
  
  int                    _iCurL1Node;
  SmlDataFileL1NodeType  _curL1Node;  
    
  std::vector<uint8_t>   _lCurEvrEvent;
...
#endif // #ifndef Pds_SmlData_SmlDataFileReader_hh
