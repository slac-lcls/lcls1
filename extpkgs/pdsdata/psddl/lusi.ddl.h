#ifndef PDS_LUSI_DDL_H
#define PDS_LUSI_DDL_H 1
...
public:
  ...
  enum { Version = 1 /**< XTC type version number */ };
  enum { NCHANNELS = 4 };
  IpmFexConfigV1(const Lusi::DiodeFexConfigV1* arg__diode, float arg__xscale, float arg__yscale)
