#ifndef PDS_IMP_DDL_H
#define PDS_IMP_DDL_H 1
...
public:
  ...
  ConfigV1(uint32_t arg__range, uint32_t arg__calRange, uint32_t arg__reset, uint32_t arg__biasData, uint32_t arg__calData, uint32_t arg__biasDacData, uint32_t arg__calStrobe, uint32_t arg__numberOfSamples, uint32_t arg__trigDelay, uint32_t arg__adcDelay)
    : _range(arg__range), _calRange(arg__calRange), _reset(arg__reset), _biasData(arg__biasData), _calData(arg__calData), _biasDacData(arg__biasDacData), _calStrobe(arg__calStrobe), _numberOfSamples(arg__numberOfSamples), _trigDelay(arg__trigDelay), _adcDelay(arg__adcDelay)
  {
  }
  ConfigV1() {}
