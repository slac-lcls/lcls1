...
ConfigV1::ConfigV1(uint16_t arg__bf_offset, uint16_t arg__bf_gain, Opal1k::ConfigV1::Depth arg__bf_resol, Opal1k::ConfigV1::Binning arg__bf_vbin, Opal1k::ConfigV1::Mirroring arg__bf_mirr, uint8_t arg__bf_vremap, uint8_t arg__bf_lookup, uint8_t arg__bf_corr, uint32_t arg__defectPixelCount, const uint16_t* arg__lookup_table, const Camera::FrameCoord* arg__defectPixels)
    : _offsetAndGain(((arg__bf_offset) & 0xffff)|(((arg__bf_gain) & 0xffff)<<16)), _outputOptions(((arg__bf_resol) & 0xf)|(((arg__bf_vbin) & 0xf)<<4)|(((arg__bf_mirr) & 0xf)<<8)|(((arg__bf_vremap) & 0x1)<<12)|(((arg__bf_lookup) & 0x1)<<13)|(((arg__bf_corr) & 0x1)<<14)), _defectPixelCount(arg__defectPixelCount)
{
