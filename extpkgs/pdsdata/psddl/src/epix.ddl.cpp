...
Config10kaV2::Config10kaV2(uint32_t arg__version, uint32_t arg__usePgpEvr, uint32_t arg__evrRunCode, uint32_t arg__evrDaqCode, uint32_t arg__evrRunTrigDelay, uint32_t arg__epixRunTrigDelay, uint32_t arg__epixDaqTrigDelay, uint32_t arg__dacSetting, uint8_t arg__asicGR, uint8_t arg__asicAcq, uint8_t arg__asicR0, uint8_t arg__asicPpmat, uint8_t arg__asicPpbe, uint8_t arg__asicRoClk, uint8_t arg__asicGRControl, uint8_t arg__asicAcqControl, uint8_t arg__asicR0Control, uint8_t arg__asicPpmatControl, uint8_t arg__asicPpbeControl, uint8_t arg__asicR0ClkControl, uint8_t arg__prepulseR0En, uint32_t arg__adcStreamMode, uint8_t arg__testPatternEnable, uint32_t arg__acqToAsicR0Delay, uint32_t arg__asicR0ToAsicAcq, uint32_t arg__asicAcqWidth, uint32_t arg__asicAcqLToPPmatL, uint32_t arg__asicPPmatToReadout, uint32_t arg__asicRoClkHalfT, uint32_t arg__adcClkHalfT, uint32_t arg__asicR0Width, uint32_t arg__adcPipelineDelay, uint32_t arg__adcPipelineDelay0, uint32_t arg__adcPipelineDelay1, uint32_t arg__adcPipelineDelay2, uint32_t arg__adcPipelineDelay3, uint16_t arg__SyncWidth, uint16_t arg__SyncDelay, uint32_t arg__prepulseR0Width, uint32_t arg__prepulseR0Delay, uint32_t arg__digitalCardId0, uint32_t arg__digitalCardId1, uint32_t arg__analogCardId0, uint32_t arg__analogCardId1, uint32_t arg__carrierId0, uint32_t arg__carrierId1, uint32_t arg__numberOfAsicsPerRow, uint32_t arg__numberOfAsicsPerColumn, uint32_t arg__numberOfRowsPerAsic, uint32_t arg__numberOfReadableRowsPerAsic, uint32_t arg__numberOfPixelsPerAsicRow, uint32_t arg__calibrationRowCountPerASIC, uint32_t arg__environmentalRowCountPerASIC, uint32_t arg__baseClockFrequency, uint32_t arg__asicMask, uint32_t arg__enableAutomaticRunTrigger, uint32_t arg__numberOf125MhzTicksPerRunTrigger, uint32_t arg__ghostCorrEn, uint32_t arg__oversampleEn, uint32_t arg__oversampleSize, uint8_t arg__scopeEnable, uint8_t arg__scopeTrigEdge, uint8_t arg__scopeTrigChan, uint8_t arg__scopeArmMode, uint16_t arg__scopeADCThreshold, uint16_t arg__scopeTrigHoldoff, uint16_t arg__scopeTrigOffset, uint16_t arg__scopeTraceLength, uint16_t arg__scopeADCsameplesToSkip, uint8_t arg__scopeChanAwaveformSelect, uint8_t arg__scopeChanBwaveformSelect, const char* arg__firmwareHash, const char* arg__firmwareDesc, const Epix::Asic10kaConfigV1* arg__asics, const uint16_t* arg__asicPixelConfigArray, const uint8_t* arg__calibPixelConfigArray)
    : _version(arg__version), _usePgpEvr(arg__usePgpEvr), _evrRunCode(arg__evrRunCode), _evrDaqCode(arg__evrDaqCode), _evrRunTrigDelay(arg__evrRunTrigDelay), _epixRunTrigDelay(arg__epixRunTrigDelay), _epixDaqTrigDelay(arg__epixDaqTrigDelay), _dacSetting(arg__dacSetting), _asicPins(((arg__asicGR) & 0x1)|(((arg__asicAcq) & 0x1)<<1)|(((arg__asicR0) & 0x1)<<2)|(((arg__asicPpmat) & 0x1)<<3)|(((arg__asicPpbe) & 0x1)<<4)|(((arg__asicRoClk) & 0x1)<<5)), _asicControls(((arg__asicGRControl) & 0x1)|(((arg__asicAcqControl) & 0x1)<<1)|(((arg__asicR0Control) & 0x1)<<2)|(((arg__asicPpmatControl) & 0x1)<<3)|(((arg__asicPpbeControl) & 0x1)<<4)|(((arg__asicR0ClkControl) & 0x1)<<5)|(((arg__prepulseR0En) & 0x1)<<6)|(((arg__adcStreamMode) & 0x1)<<7)|(((arg__testPatternEnable) & 0x1)<<8)), _acqToAsicR0Delay(arg__acqToAsicR0Delay), _asicR0ToAsicAcq(arg__asicR0ToAsicAcq), _asicAcqWidth(arg__asicAcqWidth), _asicAcqLToPPmatL(arg__asicAcqLToPPmatL), _asicPPmatToReadout(arg__asicPPmatToReadout), _asicRoClkHalfT(arg__asicRoClkHalfT), _adcClkHalfT(arg__adcClkHalfT), _asicR0Width(arg__asicR0Width), _adcPipelineDelay(arg__adcPipelineDelay), _adcPipelineDelay0(arg__adcPipelineDelay0), _adcPipelineDelay1(arg__adcPipelineDelay1), _adcPipelineDelay2(arg__adcPipelineDelay2), _adcPipelineDelay3(arg__adcPipelineDelay3), _Sync(((arg__SyncWidth) & 0xffff)|(((arg__SyncDelay) & 0xffff)<<16)), _prepulseR0Width(arg__prepulseR0Width), _prepulseR0Delay(arg__prepulseR0Delay), _digitalCardId0(arg__digitalCardId0), _digitalCardId1(arg__digitalCardId1), _analogCardId0(arg__analogCardId0), _analogCardId1(arg__analogCardId1), _carrierId0(arg__carrierId0), _carrierId1(arg__carrierId1), _numberOfAsicsPerRow(arg__numberOfAsicsPerRow), _numberOfAsicsPerColumn(arg__numberOfAsicsPerColumn), _numberOfRowsPerAsic(arg__numberOfRowsPerAsic), _numberOfReadableRowsPerAsic(arg__numberOfReadableRowsPerAsic), _numberOfPixelsPerAsicRow(arg__numberOfPixelsPerAsicRow), _calibrationRowCountPerASIC(arg__calibrationRowCountPerASIC), _environmentalRowCountPerASIC(arg__environmentalRowCountPerASIC), _baseClockFrequency(arg__baseClockFrequency), _asicMask(arg__asicMask), _enableAutomaticRunTrigger(arg__enableAutomaticRunTrigger), _numberOf125MhzTicksPerRunTrigger(arg__numberOf125MhzTicksPerRunTrigger), _ghostCorrEn(arg__ghostCorrEn), _oversampleEn(arg__oversampleEn), _oversampleSize(arg__oversampleSize), _Scope(((arg__scopeEnable) & 0x1)|(((arg__scopeTrigEdge) & 0x1)<<1)|(((arg__scopeTrigChan) & 0xf)<<2)|(((arg__scopeArmMode) & 0x3)<<6)|(((arg__scopeADCThreshold) & 0xffff)<<16)), _ScopeTriggerParms_1(((arg__scopeTrigHoldoff) & 0x1fff)|(((arg__scopeTrigOffset) & 0x1fff)<<13)), _ScopeTriggerParms_2(((arg__scopeTraceLength) & 0x1fff)|(((arg__scopeADCsameplesToSkip) & 0x1fff)<<13)), _ScopeWaveformSelects(((arg__scopeChanAwaveformSelect) & 0x1f)|(((arg__scopeChanBwaveformSelect) & 0x1f)<<5))
{
  if (arg__firmwareHash) std::copy(arg__firmwareHash, arg__firmwareHash+(64), &_firmwareHash[0]);
  if (arg__firmwareDesc) std::copy(arg__firmwareDesc, arg__firmwareDesc+(256), &_firmwareDesc[0]);
  if (arg__asics and (this->numberOfAsicsPerRow()*this->numberOfAsicsPerColumn())) {
    ptrdiff_t offset = 520;
    Epix::Asic10kaConfigV1* data = reinterpret_cast<Epix::Asic10kaConfigV1*>(((char*)this)+offset);
    std::copy(arg__asics, arg__asics+(this->numberOfAsicsPerRow()*this->numberOfAsicsPerColumn()), data);
  }
  if (arg__asicPixelConfigArray and (( this->numberOfRows())*( this->numberOfColumns()))) {
...
std::vector<int>
Config10kaV2::firmwareHash_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(FirmwareHashMax);
  return shape;
}
std::vector<int>
Config10kaV2::firmwareDesc_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(FirmwareDescMax);
  return shape;
}
std::vector<int>
Config10kaV2::asics_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(this->numberOfAsicsPerRow()*this->numberOfAsicsPerColumn());
  return shape;
}
Elem10kaConfigV1::Elem10kaConfigV1(uint32_t arg__carrierId0, uint32_t arg__carrierId1, uint32_t arg__asicMask, const Epix::Asic10kaConfigV1* arg__asics, const uint16_t* arg__asicPixelConfigArray, const uint8_t* arg__calibPixelConfigArray)
    : _carrierId0(arg__carrierId0), _carrierId1(arg__carrierId1), _asicMask(arg__asicMask)
{
  if (arg__asics) std::copy(arg__asics, arg__asics+(4), &_asics[0]);
  if (arg__asicPixelConfigArray) std::copy(arg__asicPixelConfigArray, arg__asicPixelConfigArray+(135168), &_asicPixelConfigArray[0][0]);
  if (arg__calibPixelConfigArray) std::copy(arg__calibPixelConfigArray, arg__calibPixelConfigArray+(768), &_calibPixelConfigArray[0][0]);
}
uint32_t
Elem10kaConfigV1::numberOfAsicsPerRow() const {
  return _numberOfAsicsPerRow;
}
uint32_t
Elem10kaConfigV1::numberOfAsicsPerColumn() const {
  return _numberOfAsicsPerColumn;
}
uint32_t
Elem10kaConfigV1::numberOfRowsPerAsic() const {
  return _numberOfRowsPerAsic;
}
uint32_t
Elem10kaConfigV1::numberOfReadableRowsPerAsic() const {
  return _numberOfReadableRowsPerAsic;
}
uint32_t
Elem10kaConfigV1::numberOfPixelsPerAsicRow() const {
  return _numberOfPixelsPerAsicRow;
}
uint32_t
Elem10kaConfigV1::calibrationRowCountPerASIC() const {
  return _calibrationRowCountPerASIC;
}
uint32_t
Elem10kaConfigV1::environmentalRowCountPerASIC() const {
  return _environmentalRowCountPerASIC;
}
std::vector<int>
Elem10kaConfigV1::asics_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(4);
  return shape;
}
PgpEvrConfig::PgpEvrConfig(uint16_t arg__enable, uint8_t arg__runCode, uint8_t arg__daqCode, uint32_t arg__runDelay)
    : _enable(arg__enable), _runCode(arg__runCode), _daqCode(arg__daqCode), _runDelay(arg__runDelay)
{
}
Ad9249Config::Ad9249Config(uint32_t arg__chipId, uint32_t arg__devIndexMask, uint32_t arg__devIndexMaskDcoFco, uint8_t arg__extPwdnMode, uint8_t arg__intPwdnMode, uint8_t arg__chopMode, uint8_t arg__dutyCycleStab, uint8_t arg__outputInvert, uint8_t arg__outputFormat, uint32_t arg__clockDivide, uint32_t arg__userTestMode, uint32_t arg__outputTestMode, uint32_t arg__offsetAdjust, const uint32_t* arg__channelDelay, uint32_t arg__frameDelay)
    : _chipId(arg__chipId), _devIndexMask(arg__devIndexMask), _devIndexMaskDcoFco(arg__devIndexMaskDcoFco), ControlBits(((arg__extPwdnMode) & 0x1)|(((arg__intPwdnMode) & 0x3)<<1)|(((arg__chopMode) & 0x1)<<3)|(((arg__dutyCycleStab) & 0x1)<<4)|(((arg__outputInvert) & 0x1)<<5)|(((arg__outputFormat) & 0x1)<<6)), _clockDivide(arg__clockDivide), _userTestMode(arg__userTestMode), _outputTestMode(arg__outputTestMode), _offsetAdjust(arg__offsetAdjust), _frameDelay(arg__frameDelay)
{
  if (arg__channelDelay) std::copy(arg__channelDelay, arg__channelDelay+(8), &_channelDelay[0]);
}
Quad10kaConfigV1::Quad10kaConfigV1(uint32_t arg__baseClockFrequency, uint32_t arg__enableAutomaticRunTrigger, uint32_t arg__numberOf125MhzTicksPerRunTrigger, uint32_t arg__digitalCardId0, uint32_t arg__digitalCardId1, uint32_t arg__dcdcEn, uint32_t arg__asicAnaEn, uint32_t arg__asicDigEn, uint32_t arg__ddrVttEn, uint32_t arg__trigSrcSel, uint32_t arg__vguardDac, uint32_t arg__acqToAsicR0Delay, uint32_t arg__asicR0Width, uint32_t arg__asicR0ToAsicAcq, uint32_t arg__asicAcqWidth, uint32_t arg__asicAcqLToPPmatL, uint32_t arg__asicPPmatToReadout, uint32_t arg__asicRoClkHalfT, uint8_t arg_asicAcqForce, uint8_t arg_asicR0Force, uint8_t arg_asicPPmatForce, uint8_t arg_asicSyncForce, uint8_t arg_asicRoClkForce, uint8_t arg_asicAcqValue, uint8_t arg_asicR0Value, uint8_t arg_asicPPmatValue, uint8_t arg_asicSyncValue, uint8_t arg_asicRoClkValue, uint32_t arg__adcPipelineDelay, uint32_t arg__testData, uint8_t arg__scopeEnable, uint8_t arg__scopeTrigEdge, uint8_t arg__scopeTrigChan, uint8_t arg__scopeTrigMode, uint16_t arg__scopeADCThreshold, uint16_t arg__scopeTrigHoldoff, uint16_t arg__scopeTrigOffset, uint16_t arg__scopeTraceLength, uint16_t arg__scopeADCsamplesToSkip, uint8_t arg__scopeChanAwaveformSelect, uint8_t arg__scopeChanBwaveformSelect, uint32_t arg__scopeTrigDelay, const Epix::Ad9249Config* arg__adc, uint32_t arg__testChannel, uint32_t arg__testDataMask, uint32_t arg__testPattern, uint32_t arg__testSamples, uint32_t arg__testTimeout, uint32_t arg__testRequest)
    : _baseClockFrequency(arg__baseClockFrequency), _enableAutomaticRunTrigger(arg__enableAutomaticRunTrigger), _numberOf125MhzTicksPerRunTrigger(arg__numberOf125MhzTicksPerRunTrigger), _digitalCardId0(arg__digitalCardId0), _digitalCardId1(arg__digitalCardId1), _dcdcEn(arg__dcdcEn), _asicAnaEn(arg__asicAnaEn), _asicDigEn(arg__asicDigEn), _ddrVttEn(arg__ddrVttEn), _trigSrcSel(arg__trigSrcSel), _vguardDac(arg__vguardDac), _acqToAsicR0Delay(arg__acqToAsicR0Delay), _asicR0Width(arg__asicR0Width), _asicR0ToAsicAcq(arg__asicR0ToAsicAcq), _asicAcqWidth(arg__asicAcqWidth), _asicAcqLToPPmatL(arg__asicAcqLToPPmatL), _asicPPmatToReadout(arg__asicPPmatToReadout), _asicRoClkHalfT(arg__asicRoClkHalfT), _asicForce(((arg_asicAcqForce) & 0x1)|(((arg_asicR0Force) & 0x1)<<1)|(((arg_asicPPmatForce) & 0x1)<<2)|(((arg_asicSyncForce) & 0x1)<<3)|(((arg_asicRoClkForce) & 0x1)<<4)), _asicForceValue(((arg_asicAcqValue) & 0x1)|(((arg_asicR0Value) & 0x1)<<1)|(((arg_asicPPmatValue) & 0x1)<<2)|(((arg_asicSyncValue) & 0x1)<<3)|(((arg_asicRoClkValue) & 0x1)<<4)), _adcPipelineDelay(arg__adcPipelineDelay), _testData(arg__testData), _Scope(((arg__scopeEnable) & 0x1)|(((arg__scopeTrigEdge) & 0x1)<<1)|(((arg__scopeTrigChan) & 0x1f)<<2)|(((arg__scopeTrigMode) & 0x3)<<7)|(((arg__scopeADCThreshold) & 0xffff)<<16)), _ScopeTriggerParms_1(((arg__scopeTrigHoldoff) & 0x1fff)|(((arg__scopeTrigOffset) & 0x1fff)<<13)), _ScopeTriggerParms_2(((arg__scopeTraceLength) & 0x1fff)|(((arg__scopeADCsamplesToSkip) & 0x1fff)<<13)), _ScopeWaveformSelects(((arg__scopeChanAwaveformSelect) & 0x7f)|(((arg__scopeChanBwaveformSelect) & 0x7f)<<7)), _scopeTrigDelay(arg__scopeTrigDelay), _testChannel(arg__testChannel), _testDataMask(arg__testDataMask), _testPattern(arg__testPattern), _testSamples(arg__testSamples), _testTimeout(arg__testTimeout), _testRequest(arg__testRequest)
{
  if (arg__adc) std::copy(arg__adc, arg__adc+(10), &_adc[0]);
}
std::vector<int>
Quad10kaConfigV1::adc_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(10);
  return shape;
}
Quad10kaConfigV2::Quad10kaConfigV2(uint32_t arg__baseClockFrequency, uint32_t arg__enableAutomaticRunTrigger, uint32_t arg__numberOf125MhzTicksPerRunTrigger, uint32_t arg__firmwareVersion, uint32_t arg__digitalCardId0, uint32_t arg__digitalCardId1, const char* arg__firmwareHash, const char* arg__firmwareDesc, uint32_t arg__dcdcEn, uint32_t arg__asicAnaEn, uint32_t arg__asicDigEn, uint32_t arg__ddrVttEn, uint32_t arg__trigSrcSel, uint32_t arg__vguardDac, uint32_t arg__acqToAsicR0Delay, uint32_t arg__asicR0Width, uint32_t arg__asicR0ToAsicAcq, uint32_t arg__asicAcqWidth, uint32_t arg__asicAcqLToPPmatL, uint32_t arg__asicPPmatToReadout, uint32_t arg__asicRoClkHalfT, uint8_t arg_asicAcqForce, uint8_t arg_asicR0Force, uint8_t arg_asicPPmatForce, uint8_t arg_asicSyncForce, uint8_t arg_asicRoClkForce, uint8_t arg_asicAcqValue, uint8_t arg_asicR0Value, uint8_t arg_asicPPmatValue, uint8_t arg_asicSyncValue, uint8_t arg_asicRoClkValue, uint32_t arg__dummyAcqEn, uint32_t arg__asicSyncInjEn, uint32_t arg__asicSyncInjDly, uint32_t arg__adcPipelineDelay, uint32_t arg__testData, uint32_t arg__overSampleEn, uint32_t arg__overSampleSize, uint8_t arg__scopeEnable, uint8_t arg__scopeTrigEdge, uint8_t arg__scopeTrigChan, uint8_t arg__scopeTrigMode, uint16_t arg__scopeADCThreshold, uint16_t arg__scopeTrigHoldoff, uint16_t arg__scopeTrigOffset, uint16_t arg__scopeTraceLength, uint16_t arg__scopeADCsamplesToSkip, uint8_t arg__scopeChanAwaveformSelect, uint8_t arg__scopeChanBwaveformSelect, uint32_t arg__scopeTrigDelay, const Epix::Ad9249Config* arg__adc, uint32_t arg__testChannel, uint32_t arg__testDataMask, uint32_t arg__testPattern, uint32_t arg__testSamples, uint32_t arg__testTimeout, uint32_t arg__testRequest)
    : _baseClockFrequency(arg__baseClockFrequency), _enableAutomaticRunTrigger(arg__enableAutomaticRunTrigger), _numberOf125MhzTicksPerRunTrigger(arg__numberOf125MhzTicksPerRunTrigger), _firmwareVersion(arg__firmwareVersion), _digitalCardId0(arg__digitalCardId0), _digitalCardId1(arg__digitalCardId1), _dcdcEn(arg__dcdcEn), _asicAnaEn(arg__asicAnaEn), _asicDigEn(arg__asicDigEn), _ddrVttEn(arg__ddrVttEn), _trigSrcSel(arg__trigSrcSel), _vguardDac(arg__vguardDac), _acqToAsicR0Delay(arg__acqToAsicR0Delay), _asicR0Width(arg__asicR0Width), _asicR0ToAsicAcq(arg__asicR0ToAsicAcq), _asicAcqWidth(arg__asicAcqWidth), _asicAcqLToPPmatL(arg__asicAcqLToPPmatL), _asicPPmatToReadout(arg__asicPPmatToReadout), _asicRoClkHalfT(arg__asicRoClkHalfT), _asicForce(((arg_asicAcqForce) & 0x1)|(((arg_asicR0Force) & 0x1)<<1)|(((arg_asicPPmatForce) & 0x1)<<2)|(((arg_asicSyncForce) & 0x1)<<3)|(((arg_asicRoClkForce) & 0x1)<<4)), _asicForceValue(((arg_asicAcqValue) & 0x1)|(((arg_asicR0Value) & 0x1)<<1)|(((arg_asicPPmatValue) & 0x1)<<2)|(((arg_asicSyncValue) & 0x1)<<3)|(((arg_asicRoClkValue) & 0x1)<<4)), _dummyAcqEn(arg__dummyAcqEn), _asicSyncInjEn(arg__asicSyncInjEn), _asicSyncInjDly(arg__asicSyncInjDly), _adcPipelineDelay(arg__adcPipelineDelay), _testData(arg__testData), _overSampleEn(arg__overSampleEn), _overSampleSize(arg__overSampleSize), _Scope(((arg__scopeEnable) & 0x1)|(((arg__scopeTrigEdge) & 0x1)<<1)|(((arg__scopeTrigChan) & 0x1f)<<2)|(((arg__scopeTrigMode) & 0x3)<<7)|(((arg__scopeADCThreshold) & 0xffff)<<16)), _ScopeTriggerParms_1(((arg__scopeTrigHoldoff) & 0x1fff)|(((arg__scopeTrigOffset) & 0x1fff)<<13)), _ScopeTriggerParms_2(((arg__scopeTraceLength) & 0x1fff)|(((arg__scopeADCsamplesToSkip) & 0x1fff)<<13)), _ScopeWaveformSelects(((arg__scopeChanAwaveformSelect) & 0x7f)|(((arg__scopeChanBwaveformSelect) & 0x7f)<<7)), _scopeTrigDelay(arg__scopeTrigDelay), _testChannel(arg__testChannel), _testDataMask(arg__testDataMask), _testPattern(arg__testPattern), _testSamples(arg__testSamples), _testTimeout(arg__testTimeout), _testRequest(arg__testRequest)
{
  if (arg__firmwareHash) std::copy(arg__firmwareHash, arg__firmwareHash+(64), &_firmwareHash[0]);
  if (arg__firmwareDesc) std::copy(arg__firmwareDesc, arg__firmwareDesc+(256), &_firmwareDesc[0]);
  if (arg__adc) std::copy(arg__adc, arg__adc+(10), &_adc[0]);
...
std::vector<int>
Quad10kaConfigV2::firmwareHash_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(FirmwareHashMax);
  return shape;
...
std::vector<int>
Quad10kaConfigV2::firmwareDesc_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(FirmwareDescMax);
  return shape;
...
std::vector<int>
Quad10kaConfigV2::adc_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(10);
  return shape;
}
Config10kaQuadV1::Config10kaQuadV1(const Epix::PgpEvrConfig& arg__evr, const Epix::Quad10kaConfigV1& arg__quad, const Epix::Elem10kaConfigV1* arg__elem)
    : _evr(arg__evr), _quad(arg__quad)
{
  if (arg__elem) std::copy(arg__elem, arg__elem+(4), &_elem[0]);
}
uint32_t
Config10kaQuadV1::numberOfRows() const {
  return Elem10kaConfigV1::_numberOfAsicsPerColumn * Elem10kaConfigV1::_numberOfRowsPerAsic;
}
uint32_t
Config10kaQuadV1::numberOfReadableRows() const {
  return Elem10kaConfigV1::_numberOfAsicsPerColumn * Elem10kaConfigV1::_numberOfReadableRowsPerAsic;
}
uint32_t
Config10kaQuadV1::numberOfColumns() const {
  return Elem10kaConfigV1::_numberOfAsicsPerRow * Elem10kaConfigV1::_numberOfPixelsPerAsicRow;
}
uint32_t
Config10kaQuadV1::numberOfCalibrationRows() const {
  return Elem10kaConfigV1::_calibrationRowCountPerASIC * Elem10kaConfigV1::_numberOfAsicsPerColumn;
}
uint32_t
Config10kaQuadV1::numberOfEnvironmentalRows() const {
  return Elem10kaConfigV1::_environmentalRowCountPerASIC * Elem10kaConfigV1::_numberOfAsicsPerColumn;
}
uint32_t
Config10kaQuadV1::numberOfAsics() const {
  return Elem10kaConfigV1::_numberOfAsicsPerRow * Elem10kaConfigV1::_numberOfAsicsPerColumn * this->_numberOfElements;
}
std::vector<int>
Config10kaQuadV1::elemCfg_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(4);
  return shape;
}
Config10kaQuadV2::Config10kaQuadV2(const Epix::PgpEvrConfig& arg__evr, const Epix::Quad10kaConfigV2& arg__quad, const Epix::Elem10kaConfigV1* arg__elem)
    : _evr(arg__evr), _quad(arg__quad)
{
  if (arg__elem) std::copy(arg__elem, arg__elem+(4), &_elem[0]);
}
uint32_t
Config10kaQuadV2::numberOfRows() const {
  return Elem10kaConfigV1::_numberOfAsicsPerColumn * Elem10kaConfigV1::_numberOfRowsPerAsic;
}
uint32_t
Config10kaQuadV2::numberOfReadableRows() const {
  return Elem10kaConfigV1::_numberOfAsicsPerColumn * Elem10kaConfigV1::_numberOfReadableRowsPerAsic;
}
uint32_t
Config10kaQuadV2::numberOfColumns() const {
  return Elem10kaConfigV1::_numberOfAsicsPerRow * Elem10kaConfigV1::_numberOfPixelsPerAsicRow;
}
uint32_t
Config10kaQuadV2::numberOfCalibrationRows() const {
  return Elem10kaConfigV1::_calibrationRowCountPerASIC * Elem10kaConfigV1::_numberOfAsicsPerColumn;
}
uint32_t
Config10kaQuadV2::numberOfEnvironmentalRows() const {
  return Elem10kaConfigV1::_environmentalRowCountPerASIC * Elem10kaConfigV1::_numberOfAsicsPerColumn;
}
uint32_t
Config10kaQuadV2::numberOfAsics() const {
  return Elem10kaConfigV1::_numberOfAsicsPerRow * Elem10kaConfigV1::_numberOfAsicsPerColumn * this->_numberOfElements;
}
std::vector<int>
Config10kaQuadV2::elemCfg_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(4);
  return shape;
}
Config10ka2MV1::Config10ka2MV1(const Epix::PgpEvrConfig& arg__evr, const Epix::Quad10kaConfigV1* arg__quad, const Epix::Elem10kaConfigV1* arg__elem)
    : _evr(arg__evr)
{
  if (arg__quad) std::copy(arg__quad, arg__quad+(4), &_quad[0]);
  if (arg__elem) std::copy(arg__elem, arg__elem+(16), &_elem[0]);
}
uint32_t
Config10ka2MV1::numberOfRows() const {
  return Elem10kaConfigV1::_numberOfAsicsPerColumn * Elem10kaConfigV1::_numberOfRowsPerAsic;
}
uint32_t
Config10ka2MV1::numberOfReadableRows() const {
  return Elem10kaConfigV1::_numberOfAsicsPerColumn * Elem10kaConfigV1::_numberOfReadableRowsPerAsic;
}
uint32_t
Config10ka2MV1::numberOfColumns() const {
  return Elem10kaConfigV1::_numberOfAsicsPerRow * Elem10kaConfigV1::_numberOfPixelsPerAsicRow;
}
uint32_t
Config10ka2MV1::numberOfCalibrationRows() const {
  return Elem10kaConfigV1::_calibrationRowCountPerASIC * Elem10kaConfigV1::_numberOfAsicsPerColumn;
}
uint32_t
Config10ka2MV1::numberOfEnvironmentalRows() const {
  return Elem10kaConfigV1::_environmentalRowCountPerASIC * Elem10kaConfigV1::_numberOfAsicsPerColumn;
}
uint32_t
Config10ka2MV1::numberOfAsics() const {
  return Elem10kaConfigV1::_numberOfAsicsPerRow * Elem10kaConfigV1::_numberOfAsicsPerColumn * this->_numberOfElements;
}
std::vector<int>
Config10ka2MV1::quad_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(4);
  return shape;
...
std::vector<int>
Config10ka2MV1::elemCfg_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(16);
  return shape;
}
Config10ka2MV2::Config10ka2MV2(const Epix::PgpEvrConfig& arg__evr, const Epix::Quad10kaConfigV2* arg__quad, const Epix::Elem10kaConfigV1* arg__elem)
    : _evr(arg__evr)
{
  if (arg__quad) std::copy(arg__quad, arg__quad+(4), &_quad[0]);
  if (arg__elem) std::copy(arg__elem, arg__elem+(16), &_elem[0]);
...
uint32_t
Config10ka2MV2::numberOfRows() const {
  return Elem10kaConfigV1::_numberOfAsicsPerColumn * Elem10kaConfigV1::_numberOfRowsPerAsic;
}
uint32_t
Config10ka2MV2::numberOfReadableRows() const {
  return Elem10kaConfigV1::_numberOfAsicsPerColumn * Elem10kaConfigV1::_numberOfReadableRowsPerAsic;
}
uint32_t
Config10ka2MV2::numberOfColumns() const {
  return Elem10kaConfigV1::_numberOfAsicsPerRow * Elem10kaConfigV1::_numberOfPixelsPerAsicRow;
}
uint32_t
Config10ka2MV2::numberOfCalibrationRows() const {
  return Elem10kaConfigV1::_calibrationRowCountPerASIC * Elem10kaConfigV1::_numberOfAsicsPerColumn;
}
uint32_t
Config10ka2MV2::numberOfEnvironmentalRows() const {
  return Elem10kaConfigV1::_environmentalRowCountPerASIC * Elem10kaConfigV1::_numberOfAsicsPerColumn;
}
uint32_t
Config10ka2MV2::numberOfAsics() const {
  return Elem10kaConfigV1::_numberOfAsicsPerRow * Elem10kaConfigV1::_numberOfAsicsPerColumn * this->_numberOfElements;
}
std::vector<int>
Config10ka2MV2::quad_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(4);
  return shape;
...
std::vector<int>
Config10ka2MV2::elemCfg_shape() const {
  std::vector<int> shape;
  shape.reserve(1);
  shape.push_back(16);
  return shape;
