#ifndef PDS_ACQIRIS_DDL_H
#define PDS_ACQIRIS_DDL_H 1
...
public:
  ...
  ConfigV1(uint32_t arg__nbrConvertersPerChannel, uint32_t arg__channelMask, uint32_t arg__nbrBanks, const Acqiris::TrigV1& arg__trig, const Acqiris::HorizV1& arg__horiz, const Acqiris::VertV1* arg__vert)
    : _nbrConvertersPerChannel(arg__nbrConvertersPerChannel), _channelMask(arg__channelMask), _nbrBanks(arg__nbrBanks), _trig(arg__trig), _horiz(arg__horiz)
  {
    if (arg__vert) std::copy(arg__vert, arg__vert+(20), &_vert[0]);
  }
  ConfigV1() {}
...
public:
  ...
  TdcConfigV1(const Acqiris::TdcChannel* arg__channel, const Acqiris::TdcAuxIO* arg__auxIO, const Acqiris::TdcVetoIO& arg__veto)
    : _veto(arg__veto)
  {
    if (arg__channel) std::copy(arg__channel, arg__channel+(8), &_channel[0]);
    if (arg__auxIO) std::copy(arg__auxIO, arg__auxIO+(2), &_auxIO[0]);
  }
  TdcConfigV1() {}
