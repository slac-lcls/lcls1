#ifndef PDS_PNCCD_DDL_H
#define PDS_PNCCD_DDL_H 1
...
public:
  ...
  ConfigV1(uint32_t arg__numLinks, uint32_t arg__payloadSizePerLink)
    : _numLinks(arg__numLinks), _payloadSizePerLink(arg__payloadSizePerLink)
  {
  }
  ConfigV1() {}
...
public:
  ...
  ConfigV2(uint32_t arg__numLinks, uint32_t arg__payloadSizePerLink, uint32_t arg__numChannels, uint32_t arg__numRows, uint32_t arg__numSubmoduleChannels, uint32_t arg__numSubmoduleRows, uint32_t arg__numSubmodules, uint32_t arg__camexMagic, const char* arg__info, const char* arg__timingFName)
    : _numLinks(arg__numLinks), _payloadSizePerLink(arg__payloadSizePerLink), _numChannels(arg__numChannels), _numRows(arg__numRows), _numSubmoduleChannels(arg__numSubmoduleChannels), _numSubmoduleRows(arg__numSubmoduleRows), _numSubmodules(arg__numSubmodules), _camexMagic(arg__camexMagic)
  {
    if (arg__info) std::copy(arg__info, arg__info+(256), &_info[0]);
    if (arg__timingFName) std::copy(arg__timingFName, arg__timingFName+(256), &_timingFName[0]);
  }
  ConfigV2() {}
