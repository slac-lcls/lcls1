#ifndef PDS_PRINCETON_DDL_H
#define PDS_PRINCETON_DDL_H 1
...
public:
  ...
  ConfigV5(uint32_t width, uint32_t height)
...
public:
  enum { TypeId = Pds::TypeId::Id_PrincetonFrame /**< XTC type ID value (from Pds::TypeId class) */ };
  enum { Version = 2 /**< XTC type version number */ };
  FrameV2(uint32_t shotIdStart, float fReadoutTime, float fTemperature)
    : _iShotIdStart(shotIdStart), _fReadoutTime(fReadoutTime), _fTemperature(fTemperature)
  {
  }
  FrameV2() {}
private:
