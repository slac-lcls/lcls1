#ifndef PDS_EVR_DDL_H
#define PDS_EVR_DDL_H 1
...
public:
  ...
  enum { Version = 3 /**< XTC type version number */ };
  DataV3(uint32_t arg__u32NumFifoEvents, const EvrData::FIFOEvent* arg__fifoEvents)
  ...
  DataV3(uint32_t u32NumFifoEvents)
...
public:
  ...
  enum { Version = 1 /**< XTC type version number */ };
  IOConfigV1(uint16_t conn, uint16_t nchannels)
    : _conn(conn), _nchannels(nchannels)
  {
  }
  IOConfigV1() {}
