#ifndef PDS_CSPAD_DDL_H
#define PDS_CSPAD_DDL_H 1
...
class CsPadDigitalPotsCfg {
public:
  CsPadDigitalPotsCfg(const uint8_t* arg__pots);
  CsPadDigitalPotsCfg() {}
...
class CsPadGainMapCfg {
public:
  CsPadGainMapCfg(const uint16_t* arg__gainMap);
  CsPadGainMapCfg() {}
...
public:
  ...
  ConfigV1(uint32_t arg__concentratorVersion, uint32_t arg__runDelay, uint32_t arg__eventCode, uint32_t arg__inactiveRunMode, uint32_t arg__activeRunMode, uint32_t arg__testDataIndex, uint32_t arg__payloadPerQuad, uint32_t arg__badAsicMask0, uint32_t arg__badAsicMask1, uint32_t arg__AsicMask, uint32_t arg__quadMask, const CsPad::ConfigV1QuadReg* arg__quads)
    : _concentratorVersion(arg__concentratorVersion), _runDelay(arg__runDelay), _eventCode(arg__eventCode), _inactiveRunMode(arg__inactiveRunMode), _activeRunMode(arg__activeRunMode), _testDataIndex(arg__testDataIndex), _payloadPerQuad(arg__payloadPerQuad), _badAsicMask0(arg__badAsicMask0), _badAsicMask1(arg__badAsicMask1), _AsicMask(arg__AsicMask), _quadMask(arg__quadMask)
  {
...
public:
  ...
  ConfigV2(uint32_t arg__concentratorVersion, uint32_t arg__runDelay, uint32_t arg__eventCode, uint32_t arg__inactiveRunMode, uint32_t arg__activeRunMode, uint32_t arg__testDataIndex, uint32_t arg__payloadPerQuad, uint32_t arg__badAsicMask0, uint32_t arg__badAsicMask1, uint32_t arg__AsicMask, uint32_t arg__quadMask, uint32_t arg__roiMask, const CsPad::ConfigV1QuadReg* arg__quads)
...
public:
  ...
  ConfigV3(uint32_t arg__concentratorVersion, uint32_t arg__runDelay, uint32_t arg__eventCode, const CsPad::ProtectionSystemThreshold* arg__protectionThresholds, uint32_t arg__protectionEnable, uint32_t arg__inactiveRunMode, uint32_t arg__activeRunMode, uint32_t arg__testDataIndex, uint32_t arg__payloadPerQuad, uint32_t arg__badAsicMask0, uint32_t arg__badAsicMask1, uint32_t arg__AsicMask, uint32_t arg__quadMask, uint32_t arg__roiMask, const CsPad::ConfigV1QuadReg* arg__quads)
    : _concentratorVersion(arg__concentratorVersion), _runDelay(arg__runDelay), _eventCode(arg__eventCode), _protectionEnable(arg__protectionEnable), _inactiveRunMode(arg__inactiveRunMode), _activeRunMode(arg__activeRunMode), _testDataIndex(arg__testDataIndex), _payloadPerQuad(arg__payloadPerQuad), _badAsicMask0(arg__badAsicMask0), _badAsicMask1(arg__badAsicMask1), _AsicMask(arg__AsicMask), _quadMask(arg__quadMask), _roiMask(arg__roiMask)
  {
...
public:
  ...
  ConfigV4(uint32_t arg__concentratorVersion, uint32_t arg__runDelay, uint32_t arg__eventCode, const CsPad::ProtectionSystemThreshold* arg__protectionThresholds, uint32_t arg__protectionEnable, uint32_t arg__inactiveRunMode, uint32_t arg__activeRunMode, uint32_t arg__testDataIndex, uint32_t arg__payloadPerQuad, uint32_t arg__badAsicMask0, uint32_t arg__badAsicMask1, uint32_t arg__AsicMask, uint32_t arg__quadMask, uint32_t arg__roiMask, const CsPad::ConfigV2QuadReg* arg__quads)
    : _concentratorVersion(arg__concentratorVersion), _runDelay(arg__runDelay), _eventCode(arg__eventCode), _protectionEnable(arg__protectionEnable), _inactiveRunMode(arg__inactiveRunMode), _activeRunMode(arg__activeRunMode), _testDataIndex(arg__testDataIndex), _payloadPerQuad(arg__payloadPerQuad), _badAsicMask0(arg__badAsicMask0), _badAsicMask1(arg__badAsicMask1), _AsicMask(arg__AsicMask), _quadMask(arg__quadMask), _roiMask(arg__roiMask)
  {
    if (arg__protectionThresholds) std::copy(arg__protectionThresholds, arg__protectionThresholds+(4), &_protectionThresholds[0]);
    if (arg__quads) std::copy(arg__quads, arg__quads+(4), &_quads[0]);
